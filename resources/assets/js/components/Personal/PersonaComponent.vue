<template>
  <section>
    <div class="tabs">
      <ul>
        <li v-for="(item, i) in menu" :class="{'is-active' : i == atual}"><a @click="atual = i">{{ item }}</a></li>
      </ul>
    </div>
    ...
    <div class="margin-left">
      <section id="sobre" v-show="atual == 0">
        ...
        <twit-component v-for="item in comments" :comment="item"></twit-component>
      ...
      <section id="conc" v-show="atual == 1">
        ...
        <div class="columns" style="margin-bottom: 0" v-for="j in 2">
          <article class="column is-2" v-for="i in 5">
      ...
      <section id="conq" v-show="atual == 3">
        ...
        <div class="columns" style="margin-bottom: 0.75rem" v-for="j in 2">
          <article class="column is-5 box" style="margin-bottom: 0.75rem; margin-left: 0.5rem" v-for="i in 2">
            <div class="columns">
